      ...
      <header className="bg-white border-b border-stone-100 shadow-sm">
        <div className="max-w-2xl mx-auto px-4 py-4 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="font-bold text-stone-900 text-[15px]">Autotim</span>
          </Link>
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4 py-16">
        <div className="w-full max-w-md space-y-6">
          ...
          <div className="text-center">
            <h1 className="text-2xl font-bold text-stone-900 mb-2">Suivre ma commande</h1>
            <p className="text-stone-500 text-sm">Entrez votre numéro de tracking pour voir le statut en temps réel</p>
          </div>
          <div className="flex gap-2">
            <input type="text" value={input} onChange={e => setInput(e.target.value)} onKeyDown={e => e.key === 'Enter' && go()} placeholder="Ex : ZRX123456"
              className="flex-1 border border-stone-200 rounded-xl px-4 py-3 text-sm font-mono focus:outline-none focus:ring-2 focus:ring-green-400 shadow-sm" autoFocus />
