  ...
  const runSync = async () => {
    ...
    try {
      const res = await fetch('/api/sync-zrexpress', {
        ...
        body: JSON.stringify({ token: token.trim(), tenantId: tenantId.trim() }),
      });
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
              ...
              <p className="text-sm text-gray-500 mb-4">
                ...
                <a href="https://app.zrexpress.app/api-rest/tokens" target="_blank"
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
              ...
              <p className="text-sm text-gray-500 mb-6">
                Cliquez sur le bouton ci-dessous pour importer toutes vos commandes ZREXpress
                dans ZREXtrack. Les commandes existantes seront mises à jour.
              </p>
                    ...
                    {result.error ? (
                      ...
                      <>
                        ...
                        <p className="text-green-600 text-sm mt-0.5">
                          {result.synced} commandes importées sur {result.total} trouvées
                        </p>
                      </>
                    )}
                  </div>
